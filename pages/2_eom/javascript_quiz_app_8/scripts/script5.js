...
const anwserArr = [['служит для защиты бака трансформатора от деформации в результате резкого повышения давления, вызванного интенсивным образованием газа'], ['служит для уменьшения площади соприкосновения трансформаторного масла с окружающим воздухом'],['служит для отслеживания уровня залитой жидкости, чтобы не допустить повреждения оборудования'],['служит для защиты от повреждений масляных баков автотрансформаторов, при выделении газообразных веществ, от снижения уровня и поступления охлаждающего и изолирующего масла в расширитель'],['служит для предотвращения образования конденсата внутри бака трансформатора']]; //Ответы в правильном порядке
const text = ['Предохранительная труба ','Расширитель','Маслоуказатель','Газовое реле','Воздухоосушитель']
